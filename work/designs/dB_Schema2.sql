...
INSERT INTO Products (product_id, product_name, product_image, product_description, product_price, category)
VALUES 
(1, 'Necklace Chain, 14K Gold','https://bit.ly/2Gxv5Hs', 'Delicate yet strong, this classic anchor chain necklace in 14k gold is the perfect carrier for pendants and dangles alike. Due to its popular princess length, it will complement both high and low necklines.', 140.40, 'Necklaces'),
(2, 'GOLD Shine™ Necklace', 'https://bit.ly/2K6KqQn', 'Create a golden look with this core ingredient: an adjustable PANDORA Shine™ necklace chain in 18K gold-plated sterling silver. Just add your perfect pendant or dangle and layer it with other necklace styles.', 115.42, 'Necklaces'),
...
(4, 'Alluring Brilliant Marquise Ring, Clear CZ & 14K Gold', 'https://bit.ly/2SL09Zc', 'Putting a new spin on the classic eternity ring, this stunning 14K gold style alternates marquise-cut stones with brilliant-cut stones, lending an appealing geometric quality to the design.', 125.90, 'Rings'),
(5, 'Linked Love Ring, PANDORA Shine™', 'https://bit.ly/2YfCo1z', 'Beam a loving expression onto your finger with this PANDORA Shine™ stacking ring in 18K gold-plated sterling silver. It adds a luxurious touch to ring stacks in an elegantly simple way.', 80.50, 'Rings'),
(6, 'Exotic Stones Ring, Pandora Shine™', 'https://bit.ly/2Y5ilCK', 'Make a bold statement with this 18k gold-plated sterling silver ring, inspired by the graphic lines of triangles. The Pandora Shine design features an exotic pattern of carefully clustered stones. The stackable ring is finished with milgrain edges. Wear with other band rings or style alone as a stand-out statement to show it off to full effect.', 115.70, 'Rings'),
(7, 'Petite Runway Mercer Pavé Rose Gold-Tone and Pearl Watch', 'https://bit.ly/2SGrwU4', 'Iridescent mother-of-pearl and pavé accents elevate our petite Runway Mercer watch with high-impact glamour. Crafted from rose gold-tone stainless steel, it features a dazzling bracelet strap inspired by our Mercer lock charm. We think it looks especially chic with an all-white ensemble.', 120.80, 'Watches'),
(8, 'Mini Lauryn Pavé Gold-Tone Watch', 'https://bit.ly/2LLlWPE', 'Our Mini Lauryn watch boasts a mother-of-pearl dial detailed with drops of pavé and Roman numeral indexes. The gold-tone bracelet strap is complemented by sparkling crystals for a brilliant effect. Let it punctuate any look with everyday glamour.', 140.20, 'Watches'),
(9, 'Jaryn Rose Gold-Tone and Acetate Watch', 'https://bit.ly/2Ype9Jj', 'A minimalist dial and ultra-slim band combine for an elevated take on our Jaryn watch. Its radiant rose gold-tone finish is highlighted by a white acetate bangle. Mix and match it with colorful styles.', 170.50, 'Watches'),
(10, 'Judith Ripka Goldtone Stainless LinkWatch', 'https://bit.ly/2Hb7lJH', 'A minimalist dial and ultra-slim band combine for an elevated take on our Jaryn watch. Its radiant rose gold-tone finish is highlighted by a white acetate bangle. Mix and match it with colorful styles.', 160.60, 'Watches'),
(11, '14K Gold Oval Byzantine Watch', 'https://bit.ly/2OYs1uI', 'Impress at all occasions with this timeless 14K yellow gold watch featuring a Byzantine-style bracelet band.',160.60, 'Watches'),
(12, 'Citizen Eco-Drive Womens Goldtone Diamond Accent Watch', 'https://bit.ly/2Gxv5Hs', 'For both the appointments you have booked months in advance and those that pop up within the hour, this diamond-accented watch makes a worthy companion. From Citizen.',200.00, 'Watches');
